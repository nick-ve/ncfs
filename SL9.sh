#!/bin/sh
##################################################################
# Script to provide a Scientific Linux 9 environment via CVMFS.  #
...
# Scientific Linux 9 environment.                                #
#                                                                #
...
#                                                                #
# $ source SL9.sh root -b -q test.cc >test.log                   #
#                                                                #
# Nick van Eijndhoven, IIHE-VUB, Brussel, April 7, 2025  09:35Z  #
##################################################################
#
### Setting the image
export SINGULARITY_IMAGE=/cvmfs/singularity.opensciencegrid.org/opensciencegrid/osgvo-el9:latest
#
### Fixing perl warning
