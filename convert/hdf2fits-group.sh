...
####################################################
# Shell script to process the conversion of all
# datasets of an HDF group into a FITS file.
#
# This shell script is launched by the
# hdf2fits-group.sub HTCondor job description script.
# See the file hdf2fits-group.sub for further details.
#
# Nick van Eijndhoven, IIHE-VUB, Brussels.
# UTC February 14, 2022  19:50
####################################################
...
cp $HOSTDIR/hdf2fits-group.py script.py
