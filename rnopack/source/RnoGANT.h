...
class RnoGANT : public NcDevice
{
 public:
  ...
  Int_t GetANTId(Int_t station,Int_t string,Int_t level) const; // Provide ID based on station, string and level indicators
 ...
 ClassDef(RnoGANT,1) // Signal (Hit) handling of an RNO-G Generic Antenna (GANT).
};
#endif
