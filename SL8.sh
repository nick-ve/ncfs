#!/bin/sh
##################################################################
# Script to provide a Scientific Linux 8 environment via CVMFS.  #
...
# Scientific Linux 8 environment.                                #
#                                                                #
...
#                                                                #
# $ source SL8.sh root -b -q test.cc >test.log                   #
#                                                                #
# Nick van Eijndhoven, IIHE-VUB, Brussel, March 27, 2025  12:05Z #
##################################################################
#
### Setting image
export SINGULARITY_IMAGE=/cvmfs/singularity.opensciencegrid.org/opensciencegrid/osgvo-el8:latest
#
### Fixing perl warning
