...
class IceChi2 : public TTask
{
 public :
  ...
  Double_t GetPsi(NcTrack* t);   // Provide Bayesian psi value for a track w.r.t. CPandel PDF
 ...
 ClassDef(IceChi2,4) // TTask derived class to perform Chi-squared track fitting
};
#endif
