...
{
 public :
  NcEventSelector(const char* name="NcEventSelector",const char* title="Event selection"); // Constructor
  virtual ~NcEventSelector();                                                              // Destructor
  NcEventSelector(const NcEventSelector& q);                 // Copy constructor
 ...
 ClassDef(NcEventSelector,2) // TTask derived class to perform generic event selection
};
#endif
