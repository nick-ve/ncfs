#!/bin/sh
##################################################################
# Script to provide a Scientific Linux 7 environment via CVMFS.  #
...
# Scientific Linux 7 environment.                                #
#                                                                #
...
#                                                                #
# $ source SL7.sh root -b -q test.cc >test.log                   #
#                                                                #
# Nick van Eijndhoven, IIHE-VUB, Brussel, March 27, 2025  12:05Z #
##################################################################
#
### Setting the image
export SINGULARITY_IMAGE=/cvmfs/singularity.opensciencegrid.org/opensciencegrid/osgvo-el7:latest
#
### Fixing perl warning
