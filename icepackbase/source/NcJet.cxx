...
// $Id: NcJet.cxx 5 2010-03-19 10:10:02Z nickve $
...
///////////////////////////////////////////////////////////////////////////
void NcJet::List(TString f,TString u)
{
...
// The defaults are f="car" and u="rad".
 ...
 for (Int_t it=1; it<=fNtrk; it++)
 {
  ...
  {
   cout << " *NcJet::List* Error : No track present." << endl; 
  }
 }
} 
///////////////////////////////////////////////////////////////////////////
void NcJet::ListAll(TString f,TString u)
{
...
///////////////////////////////////////////////////////////////////////////
TObjArray* NcJet::GetTracks(Int_t idmode,Int_t chmode,Int_t pcode)
{
...
///////////////////////////////////////////////////////////////////////////
void NcJet::ShowTracks(Int_t mode)
{
...
///////////////////////////////////////////////////////////////////////////
TObjArray* NcJet::SortTracks(Int_t mode,TObjArray* tracks)
{
...
//        TObjArray instance.
 ...
 {
  NcTrack* tx=(NcTrack*)tracks->At(i);
  ...
  for (Int_t j=0; j<=nord; j++) // put track in the right ordered position
  {
   ...
   switch (abs(mode))
   {
    case 1:
     val1=tx->GetNsignals();
     val2=((NcTrack*)fSelected->At(j))->GetNsignals();
     break;
    case 2:
     val1=tx->GetEnergy(1);
     val2=((NcTrack*)fSelected->At(j))->GetEnergy(1);
     break;
    case 3:
     val1=tx->GetMomentum(1);
     val2=((NcTrack*)fSelected->At(j))->GetMomentum(1);
     break;
    case 4:
     val1=tx->GetMass(1);
     val2=((NcTrack*)fSelected->At(j))->GetMass(1);
     break;
    case 5:
     val1=tx->GetPt(1);
     val2=((NcTrack*)fSelected->At(j))->GetPt(1);
     break;
    case 6:
     val1=tx->GetPl(1);
     val2=((NcTrack*)fSelected->At(j))->GetPl(1);
     break;
    case 7:
     val1=tx->GetEt(1);
     val2=((NcTrack*)fSelected->At(j))->GetEt(1);
     break;
    case 8:
     val1=tx->GetEl(1);
     val2=((NcTrack*)fSelected->At(j))->GetEl(1);
     break;
    case 9:
     val1=tx->GetMt(1);
     val2=((NcTrack*)fSelected->At(j))->GetMt(1);
     break;
    case 10:
     val1=tx->GetRapidity();
     val2=((NcTrack*)fSelected->At(j))->GetRapidity();
     break;
    case 11:
     val1=tx->GetPseudoRapidity();
     val2=((NcTrack*)fSelected->At(j))->GetPseudoRapidity();
     break;
    case 12:
     val1=tx->GetCharge();
     val2=((NcTrack*)fSelected->At(j))->GetCharge();
     break;
    case 13:
     val1=tx->GetProb();
     val2=((NcTrack*)fSelected->At(j))->GetProb();
     break;
   }
