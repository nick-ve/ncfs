...
cd /ice3/software/root_v5.34.38
source configure  --enable-pythia6 --with-pythia6-libdir=/ice3/software/pythia-6.4.28 --enable-gsl-shared --enable-builtin-ftgl --enable-mathmore --enable-fftw3 --enable-fitsio --enable-opengl
#
make -j4
