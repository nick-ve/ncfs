...
class NcSample : public TNamed
{
 public:
  ...
  void Enter(Double_t x,Double_t y,Double_t z,Double_t t);  // Enter value for 4-dim. sample
  void Remove(Double_t x,Double_t y,Double_t z,Double_t t); // Remove value from 4-dim. sample
 ...
 ClassDef(NcSample,1) // Statistics tools for various multi-dimensional data samples.
};
#endif
