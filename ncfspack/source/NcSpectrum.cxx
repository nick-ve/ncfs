...
// since these statements are included in the file NcSpectrum.h
...
// Modified by Nick van Eijndhoven, VUB-IIHE, Brussels, May 7, 2025  07:01Z
//@@@ ClassImp(TSpectrum)
ClassImp(NcSpectrum); // Class implementation to enable ROOT I/O


//______________________________________________________________________________
NcSpectrum::NcSpectrum() :TNamed("Spectrum", "Miroslav Morhac peak finder")
{
/**
~~~
// Constructor.
...
//______________________________________________________________________________
NcSpectrum::NcSpectrum(Int_t maxpositions, Float_t resolution)
...
//______________________________________________________________________________
void NcSpectrum::SetAverageWindow(Int_t w)
{
/**
~~~
...
//______________________________________________________________________________
void NcSpectrum::SetDeconIterations(Int_t n)
{
/**
~~~
...
//______________________________________________________________________________
void NcSpectrum::Print(Option_t *) const
{
/**
~~~
...
//______________________________________________________________________________
Int_t NcSpectrum::Search(const TH1 * hin, Double_t sigma, Option_t * option,
                        Double_t threshold)
{
/**
~~~
...
//______________________________________________________________________________
void NcSpectrum::SetResolution(Float_t resolution)
{
/**
~~~
// resolution: determines resolution of the neighboring peaks
...
//
// <img width=486 height=72 src="gif/NcSpectrum_Background.gif">
//
...
// Script:
//
// Example to illustrate the background estimator (class NcSpectrum).
...
//
// <img width=601 height=407 src="gif/NcSpectrum_Background_decr.jpg">
//
...
//
// <img width=601 height=407 src="gif/NcSpectrum_Background_width.jpg">
//
...
//
// <img width=601 height=407 src="gif/NcSpectrum_Background_width2.jpg">
//
...
//
// <img width=601 height=407 src="gif/NcSpectrum_Background_order.jpg">
//
...
//
// <img width=554 height=104 src="gif/NcSpectrum_Background_smooth1.jpg">
//
// Figure 7 Principle of background estimation algorithm with simultaneous
// smoothing.
//
// <img width=601 height=407 src="gif/NcSpectrum_Background_smooth2.jpg">
//
...
// Script:
//
// Example to illustrate the background estimator (class NcSpectrum) including
...
// (smoothingWindow=5).
//
// <img width=601 height=407 src="gif/NcSpectrum_Background_compton.jpg">
//
...
//______________________________________________________________________________
const char* NcSpectrum::SmoothMarkov(float *source, int ssize, int averWindow)
{
/**
~~~
...
//______________________________________________________________________________
Int_t NcSpectrum::SearchHighRes(float *source,float *destVector, int ssize,
...
//______________________________________________________________________________
Int_t NcSpectrum::Search1HighRes(float *source,float *destVector, int ssize,
                                     float sigma, double threshold,
                                     bool backgroundRemove,int deconIterations,
                                     bool markov, int averWindow)
{
...
//______________________________________________________________________________
Int_t NcSpectrum::StaticSearch(const TH1 *hist, Double_t sigma, Option_t *option, Double_t threshold)
{
/**
~~~
